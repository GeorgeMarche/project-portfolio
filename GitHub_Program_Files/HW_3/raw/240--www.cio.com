...
<head>
	<link rel="alternate" hreflang="en-US" href="https://www.cio.com/article/3583638/4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html" />
	...
	<title>4 tips for keeping SAP transformation projects on track during the COVID-19 crisis | CIO</title>
...
<script src="https://cmpv2.cio.com/wrapperMessagingWithoutDetection.js"></script>
...
var twitterUrl = "https://twitter.com/CIOonline";
var linkedInUrl = "https://www.linkedin.com/company/cio-online";
var facebookUrl = "https://www.facebook.com/CIOfacebook";
var youTubeUrl = "https://www.youtube.com/idgtechtalk";
var twitterHandle = "CIOonline";

if (countryCode === 'asean') {
	twitterUrl = "https://twitter.com/cio_asean";
	linkedInUrl = "https://www.linkedin.com/company/cio-asean/";
	facebookUrl = "https://www.facebook.com/CIOASEAN.IDG/";
	twitterHandle = "cio_asean";
}
if (countryCode === 'middle-east') {
	twitterUrl = "https://twitter.com/CIO_MiddleEast";
	linkedInUrl = "https://www.linkedin.com/company/cio-middle-east/";
	facebookUrl = "https://www.facebook.com/CIOMiddleEast.IDG/";
	twitterHandle = "CIO_MiddleEast";
}
if (countryCode === 'uk') {
	twitterUrl = "https://twitter.com/ciouk";
	linkedInUrl = "https://www.linkedin.com/company/cio-uk";
	facebookUrl = "https://www.facebook.com/ciouk/";
	twitterHandle = "ciouk";
}
if (countryCode === 'in') {
	twitterUrl = "https://twitter.com/CIOIn";
	linkedInUrl = "https://www.linkedin.com/company/cio-online";
	facebookUrl = "https://www.facebook.com/CIOIndiaIDG";
	twitterHandle = "cioin";
	youTubeUrl = "";
}
if (countryCode === 'africa') {
	twitterUrl = "https://twitter.com/CIOonline";
	linkedInUrl = "https://www.linkedin.com/company/cio-online";
	facebookUrl = "https://www.facebook.com/CIOfacebook";
	twitterHandle = "CIOonline";
	youTubeUrl = "";
}
if (countryCode === 'au') {
	twitterUrl = "https://twitter.com/CIO_Australia";
	linkedInUrl = "https://www.linkedin.com/company/cio-online";
	facebookUrl = "https://www.facebook.com/CIO-Australia-113718675362345/";
	twitterHandle = "CIO_Australia";
}
if (countryCode === 'nz') {
	twitterUrl = "https://twitter.com/CIO_NZ";
	linkedInUrl = "https://www.linkedin.com/company/cio-online";
	facebookUrl = "https://www.facebook.com/CIOfacebook";
	twitterHandle = "CIO_NZ";
}
if (countryCode === 'nl') {
	twitterUrl = "https://twitter.com/CioNL";
...
if (countryCode === 'middle-east') {
	busUnit = "IDG Communications, Inc.";
	localeEdition = "Middle East Edition";
	busUnitAddress = "IDG Communications, Inc. (“IDGC”)<br>5 Speen Street<br>Framingham, Massachusetts 01701<br>United States of America";
}
if (countryCode === 'uk') {
...
if (countryCode === 'nl') {
	...
	busUnitAddress = "IDG Benelux<br />Joop Geesinkweg 701-51<br />1114 AB Amsterdam<br />Netherlands";
}
</script>
	...
	<script async src="//js-sec.indexww.com/ht/p/183980-71917588787548.js"></script>
...
<script type="text/javascript">
	...
	try {
		IDG.GPT.unitName = "/8456/IDG.G_B2B_CIO.com";
	}
	catch (exception) {
	...
	try {
		IDG.GPT.unitName = IDG.GPT.unitName + "/" + "it-leadership_section";
	}
	catch (exception) {
		console.log ("google_dfp can't use IDG.GPT "+ exception);
	}
	...
	try {IDG.GPT.addTarget("zone", 'article-blog/digital-transformation');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}
	try{IDG.GPT.addTarget("channel", 'digital-transformation,it-leadership');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}try{IDG.GPT.addTarget("blogId", '2677');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}try{IDG.GPT.addTarget("articleId", '3583638');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}try{IDG.GPT.addTarget("type", 'opinion');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}try{IDG.GPT.addTarget("typeId", '5');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}try{IDG.GPT.addTarget("templateType", 'article-default');}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}
	
	try {IDG.GPT.addTarget("categoryIds", ['4037','3711','3612']);}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}
	try{IDG.GPT.addTarget("categorySlugs", ['digital-transformation','enterprise-resource-planning','it-leadership']);}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}
	try {IDG.GPT.addTarget("goldenIds", ['567','108','650']);}	catch (exception) {console.log ("google_dfp can't use IDG.GPT "+ exception);}
	try {
		...
		try {
			IDG.GPT.addTarget("author", 'Steele Arbeeny');
		}
		catch (exception) {
			console.log ("google_dfp can't use IDG.GPT "+ exception);
		}
	...
	try {
		...
		try {
			IDG.GPT.addTarget("blog_name", 'IDG TECHtalk Voices');
		}
		catch (exception) {
			console.log ("google_dfp can't use IDG.GPT "+ exception);
		}
...
<script type="text/javascript" src="/www/js/ads/gpt_starter.js?1234"></script>
	...
	<link rel="canonical" href="https://www.cio.com/article/3583638/4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html" />
	
	
		
	

	<meta itemprop="url" content="https://www.cio.com/article/3583638/4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html" />
	<meta name="description" content="You can’t put mission-critical modernization projects on hold. Here’s how to work through the disruption." />
	
		
			<meta name="DC.date.issued" content="2020-09-28T08:40-05:00" />
			...
			<meta property="og:title" content="4 tips for keeping SAP transformation projects on track during the COVID-19 crisis">
		
	
	<meta property="og:description" content="You can’t put mission-critical modernization projects on hold. Here’s how to work through the disruption.">	
	
	
		
			<meta property="og:image" content="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" />
			<meta property="og:image:width" content="1200" />
			<meta property="og:image:height" content="800" />
			<meta itemprop="image" content="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" />
			<meta itemprop="thumbnailURl" content="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" />
			<link rel="image_src" href="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" />
			<meta name="twitter:image" content="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" />
			...
			<meta name="author" content="Steele Arbeeny">
	...
	<meta property="fb:app_id" content="129182073794488" />
			...
			<meta property="og:url" content="https://www.cio.com/article/3583638/4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html">
	...
	<meta name="twitter:description" content="You can’t put mission-critical modernization projects on hold. Here’s how to work through the disruption.">
	...
	<meta name="robots" content="NOODP,NOYDIR" />
		...
		<meta name="msvalidate.01" content="B6D65511A0CC5522E695818081C251B8" />
	...
	<!-- css -->
		...
		<link rel="stylesheet" href="/www.idge/css/print.css" media="print" />
					...
					<link rel="stylesheet" href="/www.idge.cio/css/article.css?v=20201007113303" />
	...
	<![endif]--> 
		...
		<link rel="stylesheet" href="https://use.typekit.net/sqc0dqh.css" />
	
	
	<!--  fav and touch icons -->
	<link rel="shortcut icon" type="image/x-icon" href="https://idge.staticworld.net/cio/favicon.ico"/>
	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="https://idge.staticworld.net/cio/CIO_logo_144x144.png" />
	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="https://idge.staticworld.net/cio/CIO_logo_114x114.png" />
	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://idge.staticworld.net/cio/CIO_logo_72x72.png" />
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="https://idge.staticworld.net/cio/CIO_logo_57x57.png" />
	<link rel="apple-touch-icon" href="https://idge.staticworld.net/cio/CIO_logo_300x300.png" />
...
if (countryCode == 'nl') {
	...
	var supMontMods = false;
		...
		<script>	
		{	
			let categorySlug = 'digital-transformation';
	...
	var catIdList = '4037,3711,3612';
	var goldenTaxList = '567,108,650';
	var primaryCatList = 'digital transformation,erp,it leadership';
	...
	if (getQueryVariable("huid") !== false && idg_uuid === '') {
		...
		$.cookie('idg_uuid', idg_uuid, {path:'/', domain: ".cio.com", expires: 90/*,secure:true*/});
	}
	...
	dataLayer.push({
		...
		'articleLocale': 'us',
		'articleTitle': '4 tips for keeping SAP transformation projects on track during the COVID-19 crisis',
		'articleType': 'Opinion',
		'audience':'enterprise',
		'author':'Steele Arbeeny',
		'blogName':'IDG TECHtalk Voices',
		'brandpost': 'false',
		'categoryIdAll': (catIdList.length > 0 ? catIdList.split(',') : []),
		'categoryIdList':catIdList,
		'categoryIdPrimary': '4037',
		'contentStrategy': '',
		'contentType':'opinion',
		'datePublished':'2020-09-28',
		'dateUpdated':'2020-09-28',
		...
		'ga_enabled':'true',
		'gaTrackingId':'UA-300704-2',
		'geolocEnabled':'true',
		'goldenTaxArray': (goldenTaxList.length > 0 ? goldenTaxList.split(',') : []),
		'goldenTaxonomyIdAll': '567, 108, 650',
		'goldenTaxonomyIdPrimary': '567',
		'goldenTaxonomyIdList': '108,650',
		'industry': dlIndustry,
		...
		'ancestorGoldenCategories': 'it leadership',
		'primaryCatArray': (primaryCatList.length > 0 ? primaryCatList.split(',') : []),
		'primaryCategoryAll': 'digital transformation, erp, it leadership',
		'primaryCategoryList': 'erp,it leadership',
		'primaryAncestorCategoryList': 'digital transformation,software',
		...
		'property': 'cio',
		'propertyCountry':'US',
		'purchaseIntent':'awareness',
		'skimlinksId':'111346X1569474',
		'source':'cio',
		'sponsorName':'',
	...
	!function(n,e,o,r,i){if(!e){e=e||{},window.permutive=e,e.q=[],e.config=i||{},e.config.projectId=o,e.config.apiKey=r,e.config.environment=e.config.environment||"production";for(var t=["addon","identify","track","trigger","query","segment","segments","ready","on","once","user","consent"],c=0;c<t.length;c++){var f=t[c];e[f]=function(n){return function(){var o=Array.prototype.slice.call(arguments,0);e.q.push({functionName:n,arguments:o})}}(f)}}}(document,window.permutive,"f5b3be27-f789-4ef1-8867-37c67da5b361","84c7e805-5ce9-41f4-b988-3529488bab1c",{});
	  permutive.addon('web', {
	    page: {
	      ...
	      description: 'You can’t put mission-critical modernization projects on hold. Here’s how to work through the disruption.',
	      ...
	      article: {
	        ...
	        modifiedAt: "2020-09-28T08:40:26Z",
	        publishedAt: "2020-09-28T08:40:26Z",
...
if ( edition === "us" || (edition === "in" && beforeEndDate === true) || ( edition === "uk" && (brandAbbreviation === "ctw" || brandAbbreviation === "nww" || brandAbbreviation === "ifw") ) ) {
	googletag.cmd.push(function() {
		  ...
		  var custAdTag = "https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu="+IDG.GPT.unitName+"&ciu_szs=300x250,728x90&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&description_url=http%3A%2F%2Fwww.cio.com&url=[referrer_url]&correlator=[timestamp]";
		  ...
		  if (edition === 'us') {
		  	 if (true==true) {
			    	...
			    	for (let i = 0; i < [30,60,90].length; i++) { 
					  customAdRoll.push({
				         "tag": custAdTag,
				         "offset": [30,60,90][i],
				         "custParams": customParams
	...
	<body id="article3583638" class="article blog2677 cio">
...
<script>
	var isJWfloatTest = false;
		...
		<link rel="stylesheet" href="/www.idge.cio/css/oc-header.css?v=20201007113303" />
...
<section id="oc-head" class="no-stick-important">
		<div class="oc-head-inner">
			<div class="oc-head-left">
				<a href="/" class="masthead"><span class="logo">cio</span></a>
					...
					<div class="edition-picker">
						...
						<ul id="edition-picker-nav">
									   ...
									   <li class="edition-picker-item locale-africa">
									   		<a data-edition-name="africa" data-edition-localeid="8" href="/africa/">Africa </a>
									   </li>
									   ...
									   <li class="edition-picker-item locale-middle-east">
									   		<a data-edition-name="middle-east" data-edition-localeid="7" href="/middle-east/">Middle East </a>
									   </li>
...
<li><a  href="/article/3584696/how-to-speed-up-software-development-without-killing-morale.html">How to speed up software development (without killing morale)</a></li>
...
<li><a  href="/article/3584771/seeking-a-new-gig-it-leader-hiring-rebounds-remotely.html">Seeking a new gig? IT leader hiring rebounds, remotely</a></li>
...
<li><a  href="/article/3584428/ai-center-of-excellence-a-new-engine-for-driving-business-transformation.html">AI center of excellence: A new engine for driving business transformation</a></li>
...
<li><a  href="/article/3576295/secrets-of-successful-digital-innovation.html">Secrets of successful digital innovation</a></li>
...
<div class="gcse-searchbox" >
    <script>
		(function() {
			var cx = '011881588825642368632:qdznsbfg9ww';
...
<nav class="megamenu">
		<div class="megamenu-inner">
			...
			<img class="mega-logo" src="https://alt.idgesg.net/images/furniture/cio/cio-logo-nameplate.svg" />
...
<li><a  href="/article/3263392/what-is-low-code-development-a-lego-like-approach-to-building-software.html">How low-code platforms are transforming software development</a></li>
...
<li><a  href="/article/3583999/7-ways-to-effectively-ensure-it-business-alignment.html">7 ways to effectively ensure IT-business alignment</a></li>
...
<li><a  href="/article/3234364/hot-and-cold-technology-career-trends.html">5 hot IT career trends — and 5 going cold</a></li>
...
<li><a  href="/article/3583777/5-compelling-reasons-why-cios-should-pursue-board-seats-now.html">5 compelling reasons why CIOs should pursue board seats now</a></li>
			...
			<div class="mega-footer">
		            	...
		            	<ul class="mega-social">
							...
							<li class="lkndn"><a class="social-media-li" href="https://www.linkedin.com/company/cio-online" rel="nofollow" target="_blank"><i class="ss-icon ss-social-circle brand ss-linkedin"></i></a></li>
						
						
							<li><a class="social-media-tw" href="https://twitter.com/CIOonline" rel="nofollow" target="_blank"><i class="ss-icon ss-social-circle ss-twitter"></i></a></li>
						
						
							<li><a class="social-media-fb" href="https://www.facebook.com/CIOfacebook" rel="nofollow" target="_blank"><i class="ss-icon ss-social-circle brand ss-facebook"></i></a></li>				
...
<li class="item-0 ribbon-col">
	<div class="item">
		
		<div class="title"><a  href="/article/3570728/7-steps-to-prepare-it-for-a-second-wave-covid-19-outbreak.html">7 steps to prepare IT for a second-wave COVID-19 outbreak</a></div>
	</div>
</li>


	<li class="ribbon-col ribbon-hed">
		<div class="item">
			<div class="title">
				RELATED STORIES
			</div>
...
<li class="item-1 ribbon-col">
	<div class="item">
		
		<div class="title"><a  href="/article/3565768/how-dhl-express-is-digitising-logistics-through-a-period-of-change.html">How DHL Express is digitising logistics through a period of change</a></div>
	</div>
</li>
	...
	<li class="ribbon-col nativo-ribbon-item">
		<div class="title">
			<span class="item-eyebrow">SPONSORED BY <i>Advertiser Name Here</i></span>
			<a href="">Sponsored item title goes here as designed</a>
		</div>	
	</li>
...
<li class="item-2 ribbon-col">
	<div class="item">
		
		<div class="title"><a  href="/article/3570615/the-7-most-popular-it-pilot-projects-today.html">The 7 most popular IT pilot projects today</a></div>
	</div>
</li>
...
<li class="item-3 ribbon-col">
	<div class="item">
		
		<div class="title"><a  href="/article/3569350/4-hot-project-management-trends-and-4-going-cold.html">4 hot project management trends — and 4 going cold</a></div>
	</div>
</li>
...
<script src="/www/js/date-time-moments.js"></script>
		...
		<script>
		$(document).ready(function() {
			var fullDate = "2020-09-28T08:40-0700";
			var timeDate = "";
	...
	$(document).ready(function() {
		...
		<meta itemprop="keywords" content="digital transformation, erp, it leadership "/>
	...
	<nav class="breadcrumbs horiz">
		<ul itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			<li><a class="edition-link-url" href="/" itemprop="url"><span itemprop="title">Home</span></a></li>
					...
					<li><a class="edition-link-url primary-cat-url" href="/category/it-leadership/" itemprop="url"><span class="primary-cat-name" itemprop="title">IT Leadership</span></a></li>
				
				
					<li><a class="edition-link-url" href="/category/digital-transformation/" itemprop="url"><span class="article-primary-cat" itemprop="title">Digital Transformation</span></a></li>
...
<a href="/author/Steele-Arbeeny/" rel="author" title="Steele Arbeeny"><img  class="bylineImage  imgId100859906 " src="https://images.idgesg.net/images/article/2020/09/dr.-steele-arbeeny-100859906-byline.jpg" width="34" width="34" alt="Steele Arbeeny" itemprop="image" /></a>
				...
				<div class="blog-branding-text">
					...
					<div class="blog-title"><a href="/blog/idg-techtalk-voices/" class="edition-link-url">IDG TECHtalk Voices</a></div>
							...
							<p class="name" itemscope itemtype="http://schema.org/Person" itemprop="author">
								...
								By <span class="fn" itemprop="name"><a rel="author" itemprop="url" href="/author/Steele-Arbeeny/"><span itemprop="name">Steele Arbeeny</span></a></span>, 
...
<span itemprop="publisher" itemscope itemtype="http://schema.org/Organization"><span class="publisher" itemprop="name">CIO</span><meta itemprop="url" content="https://www.cio.com" /><meta itemprop="logo" content="https://idge.staticworld.net/cio/CIO_logo_300x300.png"/></span> 
								
								<span class="divider break">|</span>
								
								<span class="pub-date" class='break-date' itemprop="datePublished" 
								    content="2020-09-28T08:40-0700"><span class="format-date"></span>
	...
	<h1 itemprop="headline">4 tips for keeping SAP transformation projects on track during the COVID-19 crisis</h1>
	
	
	
	
		<section class="deck viewability">
			<h3 itemprop="description">You can’t put mission-critical modernization projects on hold. Here’s how to work through the disruption. </h3>
		</section>
...
<ul id="share-tool" class="expand">
		...
		<li class="sosh">
			<a data-socialsite="Facebook" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.cio.com%2Farticle%2F3583638%2F4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html" target="_blank">
				<img class="sidecar-icon" src="//idge.staticworld.net/images/facebook.svg" />
			</a>
		</li>	
	<li class="sosh">
		<a data-socialsite="Twitter" class="twit-hand" href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.cio.com%2Farticle%2F3583638%2F4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html&via=CIOonline&text=4+tips+for+keeping+SAP+transformation+projects+on+track+during+the+COVID-19" target="_blank">
			<img class="sidecar-icon" src="//idge.staticworld.net/images/twitter.svg" />
		</a>
	</li>
	<li class="sosh">
		<a data-socialsite="Linkedin" href="http://www.linkedin.com/shareArticle?url=https%3A%2F%2Fwww.cio.com%2Farticle%2F3583638%2F4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html&title=4+tips+for+keeping+SAP+transformation+projects+on+track+during+the+COVID-19" target="_blank">
			<img class="sidecar-icon" src="//idge.staticworld.net/images/linkedin.svg" />
		</a>
	</li>	
	<li class="sosh hide">
			<a data-socialsite="Reddit" href="http://reddit.com/submit?url=https%3A%2F%2Fwww.cio.com%2Farticle%2F3583638%2F4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html&title=4+tips+for+keeping+SAP+transformation+projects+on+track+during+the+COVID-19" target="_blank">
				<img class="sidecar-icon" src="//idge.staticworld.net/images/reddit.svg" />
			</a>
	</li>	
	<li class="sosh hide">
		<a href="mailto:?Subject=4 tips for keeping SAP transformation projects on track during the COVID-19 crisis&Body=Check%20out%20this%20article%20from%20CIO%3A%20https%3A%2F%2Fwww.cio.com%2Farticle%2F3583638%2F4-tips-for-keeping-sap-transformation-projects-on-track-during-the-covid-19-crisis.html" target="_blank" rel="nofollow" id="email-icon">
...
$(document).ready(function() {
	if (twitterHandle != "") {
		$("a[href*=via]").attr("href", function(_, href) {
			  return href.replace(/via=CIOonline/, "via="+twitterHandle);
		});
	}
	...
	<div class="constrain-970">
				...
				<div class="lede-container">
							...
							<figure itemprop="image" itemscope itemtype="http://schema.org/ImageObject" class="hero-img">
					    		...
					    		<img data-original="https://images.idgesg.net/images/article/2019/02/innovation_gears_digital-age_lightbulb_creativity_digital-transformation-100788172-large.jpg" class="lazy" loading="lazy" alt="innovation gears digital age lightbulb creativity digital transformation" itemprop="contentUrl" itemprop="url" />
...
body.techhive .embed-container #bcplayer-gallery .jw-wrapper:before {
    ...
    display: inline-block;
   	background-image: url("https://alt.idgesg.net/images/logos/cio-logo-video.svg");
   	content: ' ';
...
<script>
	var isJWfloatTest = false;
				...
				<script>
					if (supLocaleEd === true || isJWfloatTest === true) {
						$("div#inread").remove();
					} else {
			...
			<div id="drr-container" class='cat ' itemprop="articleBody">
				...
				<p>ERP transformation projects are mission critical, as most aspects of the business depend on ERP for execution. Traditionally, SAP transformation projects had to be done on-premise, but as a result of the global lockdowns today, projects must be managed and completed remotely.</p><p>This shift to remote migrations and transformations can create costly delays if not managed properly. Here are four tips to help businesses keep essential projects on track during the shift to remote work.</p><ol>
<li>
<h2><strong> Stay focused </strong></h2>
</li>
</ol><p>Businesses need to make sure transformation projects continue to get the attention they require, regardless of whether teams are working remotely. Pursuing mission-critical transformations during periods of lower activity can be the most efficient way to execute them, since it minimizes overall business impact.</p><div id="editorialfakesidebardiv" class="fakesidebar fakesidebar-auto">
 </div><p>If you already had a project in motion before the lockdowns, focus on sticking to your plan. Keep up the regular cadence of status meetings and stick to your testing dates and project timeline. With everyone working from home, communication can start to break down. In a worst-case scenario, something goes wrong, and with a lack of communication the project can’t continue as planned.</p><p>That’s why it’s important to stay engaged now, perhaps even more so than you would if things were proceeding normally. Achieving a day’s worth of work remotely may take significantly more time than it would if your project were occurring on-site. This requires a higher level of engagement on all sides to keep the project moving.</p><ol start="2">
<li>
<h2><strong> Stay connected</strong></h2>
</li>
</ol><p>Collaboration within the team is always key during transformation projects, but it’s even more important when everyone is working remotely. Otherwise, miscommunications can lead to costly delays. Of course, team members are accustomed to using tools such as Zoom and Skype, but more importantly, their end-to-end transformation authoring and delivery platform should be collaborative at its core. This enables team members to share and evaluate each other’s ideas and seamlessly pick up where another left off.</p><aside class="nativo-promo nativo-promo-1 smartphone" id=""> </aside><p>Every step of the project now needs to be carried out remotely, from planning and provisioning to execution to verification. By finding a partner already accustomed to a connected, remote work environment, the remote team is already in place with everything they need to stay connected and be successful remotely: collaboration tools, information, documentation, and lessons learned from other remote projects that they can leverage to accelerate success.</p><div id="sponsoredfakesidebardiv" class="fakesidebar fakesidebar-auto fakesidebar-sponsored">
 </div><p>Automation also plays an important role, especially during this period of uncertainty. Automated software can be there, working, even when humans are not, and automation also helps accelerate the project and minimize risks.</p><aside class="nativo-promo nativo-promo-1 tablet desktop" id=""> </aside><ol start="3">
<li>
<h2><strong> Stay secure</strong></h2>
</li>
</ol><p>Of course, keeping transformation projects moving during this time requires making sure that every person and system involved is properly enabled for remote access. But you need to do this in a way that still meets your security requirements. You’ll need a way for everyone to access systems, but systems should be properly hardened and with appropriate SIEM logging. The last thing you want to add to the timeline are the delays and costs incurred by a serious security event response.</p><p>In order to enable this safely, start by making sure remote access is secured against industry best practices, including updated policies and procedures, an incident response plan, a SIEM solution, vulnerability scanning and penetration testing, third-party audits and up-to-date patches.</p><p>Beyond that, you also want to ensure that your data does not need to leave your premise, no one is granted extraordinary access, and your standard ERP security is enforced at all times. Ideally, your transformation software should also be logging all activity and data transfer, so that information is available in case there’s an issue or an audit is required.</p><ol start="3">
<li>
<h2><strong> Stay aggressive </strong></h2>
</li>
</ol><p>By making strategic decisions about the shape of their project, enterprises can accelerate the project timeline. Perhaps you’re migrating to the cloud today, but you think you’ll also need to modernize some systems in the near future. Think about collapsing multiple transformation projects into one. Modernize the landscape and migrate in one step.</p><aside class="nativo-promo nativo-promo-2 tablet desktop smartphone" id=""> </aside><p>The more projects you do one after the next, the more time it takes and the more risks there are. By combining multiple transformation projects into one, you can minimize the risks and improve efficiency, reducing the total timeline and total costs.</p><h2> <strong>Looking ahead</strong></h2><p>With all the uncertainty swirling around lockdowns and potential reopening, one thing remains certain: Businesses cannot allow the circumstances to cause delays in essential transformation projects. By choosing the right transformation partner, ensuring security, making strategic decisions, and staying focused, businesses can keep their transformation projects on track.</p>
...
<div class="end-note">
		...
		<!-- blx4 #2003 blox4.html  -->
			...
			<div id="" class="blx blxParticleendnote blxM2003  blox4_html  blxC35767"><p><strong>Next read this:</strong></p>

<ul>
  
<li>
<a href="https://www.cio.com/article/3509974/top-9-challenges-it-leaders-will-face-in-2020.html">
Top 9 challenges IT leaders will face in 2020
</a>
</li>

<li>
<a href="https://www.cio.com/article/3489717/top-5-strategic-priorities-for-cios-in-2020.html">
Top 5 strategic priorities for CIOs in 2020
</a>
</li>

<li>
<a href="https://www.cio.com/article/3510644/7-crackpot-technologies-that-might-just-work.html">
7 'crackpot' technologies that might transform IT
</a>
</li>

<li>
<a href="https://www.cio.com/article/3254744/technologies-that-will-disrupt-business.html">
8 technologies that will disrupt business in 2020
</a>
</li>

<li>
<a href="https://www.cio.com/article/3489796/7-questions-cios-should-ask-before-taking-a-new-job.html">
7 questions CIOs should ask before taking a new job
</a>
</li>

<li>
<a href="https://www.cio.com/article/3487725/7-ways-to-position-it-for-success-in-2020.html">
7 ways to position IT for success in 2020
</a>
</li>

<li>
<a href="https://www.cio.com/article/3326539/leadership-management/the-new-rules-of-it-leadership.html">
The 9 new rules of IT leadership
</a>
</li>
  
<li>
<a href="https://www.cio.com/article/3239287/careers-staffing/20-ways-to-kill-your-it-career-without-knowing-it.html">
20 ways to kill your IT career (without knowing it)
</a>
</li>
  
<li>
<a href="https://www.cio.com/article/3332918/leadership-management/it-managers-survival-guide-11-ways-to-thrive-in-the-years-ahead.html">
IT manager’s survival guide: 11 ways to thrive in the years ahead
</a>
</li>
  
<li>
<a href="https://www.cio.com/article/3308420/resumes/cio-resumes-best-practices-and-examples.html">
CIO resumes: 6 best practices and 4 strong examples
</a>
</li>
  
<li>
<a href="https://www.cio.com/article/3327682/it-strategy/4-kpis-it-should-ditch-and-what-to-measure-instead.html">
4 KPIs IT should ditch (and what to measure instead)
	    ...
	    <ul>
				...
				<li><a class="edition-link-url primary-cat-url2" href="/category/digital-transformation"><span class="primary-cat-name2">Digital Transformation</span></a></li>
			
				<li><a class="edition-link-url primary-cat-url2" href="/category/enterprise-resource-planning"><span class="primary-cat-name2">ERP</span></a></li>
			
				<li><a class="edition-link-url primary-cat-url2" href="/category/it-leadership"><span class="primary-cat-name2">IT Leadership</span></a></li>
		...
		<div class="byline vcard author end-byline">	
			<div class="author-info">
					<p class="bio"><i>Dr. Steele G. Arbeeny is CTO of SNP Group and the architect of numerous mission-critical systems across numerous industries including technology, financial services, oil and gas, healthcare, pharmaceutical and manufacturing. As one of the industry’s thought-leaders around SAP infrastructures and migrations, he’s a patent holder and a member of the IEEE and ACM. Arbeeny has a PhD in computer engineering from Rutgers University.</i></p>
			</div><!-- end .author-info -->
			<div class="brand-social">
				<div class="follow-text">Follow</div>
				<ul class="social-links">
					<li>
						<a href="/author/Steele-Arbeeny/">
						...
						<li>
							<a href="/author/Steele-Arbeeny/index.rss" class="rss">
								<i class="ss-icon ss-social ss-rss"></i>
							</a>
						</li>
...
$("#drr-top-ad .related-promo-wrapper .title > a").on('click',function(e){
	...
	<i class="ss-icon ss-lightbulb"></i> <a href="https://www.cio.com/article/3533419/7-secrets-of-successful-remote-it-teams.html">7 secrets of successful remote IT teams</a>                                          
	</div>
...
<script>var suppressEd = false;</script>
	...
	<div id="content-recommender">
		<div class="OUTBRAIN" data-widget-id="AR_1" data-ob-template="CIO_2"></div>  
	</div>
	<script>
		var obEdition = edition ||  countryCode || '';
		var widgetId="";
		...
		if (widgetId !== "") {
			$(".OUTBRAIN").attr("data-widget-id", widgetId);
		}
		
		// suppressed for certain editions
		
		if (!suppressEd) {
			if (suppressItemsForHoliday == "false") {
...
<link rel="stylesheet" href="/www.idgcsmb/css/tso-links.css?v=20201007113303" />
	...
	<link rel="stylesheet" href="/www.idge.cio/css/foot.css?v=20201007113303" />
...
<footer>
    ...
    <section class="brand" itemscope itemtype="http://schema.org/Organization">
		...
		<li class="lnkdn"><a class="social-media-li-foot" href="https://www.linkedin.com/company/cio-online" itemprop="sameAs" rel="nofollow" target="_blank" onclick="brandFollowTrack('LinkedIn')"><i class="ss-icon ss-social-circle brand ss-linkedin"></i></a></li>
	
	
		<li><a class="social-media-tw-foot" href="https://twitter.com/CIOonline" itemprop="sameAs" rel="nofollow" target="_blank" onclick="brandFollowTrack('Twitter')"><i class="ss-icon ss-social-circle ss-twitter"></i></a></li>
	
	
		<li><a class="social-media-fb-foot" href="https://www.facebook.com/CIOfacebook" itemprop="sameAs" rel="nofollow" target="_blank" onclick="brandFollowTrack('Facebook')"><i class="ss-icon ss-social-circle brand ss-facebook"></i></a></li>				
...
<li><a class="edition-link-url" href="/about/ccpa.html"  >California: Do Not Sell My Personal Info</a>
    ...
    <section class="copyright">
        <div class="wrapper">
        		...
        		<img src="https://alt.idgesg.net/images/logos/logo-footer-black.png" alt="IDG Communications" />
...
_comscore.push(
{ c1: "2", c2: "6035308", c3: "", c5: "Digital Transformation", c6: "Article: Opinion", c15: "3583638" });
(function()
{
...
//consent.digitalelement.queue.push(function(){
	$thm.logPlEvent({"b":"cio","e":"view","t":"article","id":"3583638"});
//});
</script>
