...
try:
    ...
    # Create new labels for the chart
    f_labels = []
    user = True
    f_num = 1
    for f in f_counts:
    ...
    f_data = {'label': f_labels, 'followed_count': f_counts}
    ...
    f_bar.set(title = "How Many People Do The People Dr. Weigle Is Following Follow?",
            xlabel = "Followed User",
            ylabel = "Number of Users Followed")
    ...
    f_bar.savefig("LinFollowingCount.png")
